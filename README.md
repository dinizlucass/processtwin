...
O app fica em `web/`, não na raiz do repo — em **Project Settings → General → Root Directory**, configura `web`. Depois adiciona as variáveis de ambiente necessárias em **Project Settings → Environment Variables**.

## Assistente de processos (piloto)
